...
import type { TestReport, TestReportEntry } from "./testReportTypes";
...
class SqlOnFhirReporter implements Reporter {
  ...
  onFinished(
    ...
    if (globalThis.global !== undefined && (globalThis as any).testResults) {
      this.testReport = (globalThis as any).testResults;
    }
